  ...
  startApp() {
    gapi.load('auth2', () =>{
      ...
      this.auth2 = gapi.auth2.init({
        client_id: '921721360289-41m07g89gs96qs7rkc3hlidjlstt7r5j.apps.googleusercontent.com',
  ...
  attachSignin(element) {
    this.auth2.attachClickHandler(element, {},
        (googleUser) => {
          ...
          this.usuarioService.loginGoogle(id_token).subscribe((tokenus: any)=>{
